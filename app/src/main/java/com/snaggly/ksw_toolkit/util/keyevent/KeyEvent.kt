...
class KeyEvent(name: String, icon: Drawable, val code: Int) : ListType(name, icon) {
    ...
    companion object {
        fun getKeyEventList(context: Context) : ArrayList<KeyEvent> {
            ...
            result.add(KeyEvent(KeyCode.ASSIST.name, ContextCompat.getDrawable(context, R.drawable.ic_baseline_record_voice_over_36)!!, KeyCode.ASSIST.keycode))
            ...
            result.add(KeyEvent(KeyCode.MUTE.name, ContextCompat.getDrawable(context, R.drawable.ic_baseline_volume_mute_36)!!, KeyCode.MUTE.keycode))
