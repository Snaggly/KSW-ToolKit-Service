...
public class ActionCodes {
    ...
    public static final int GOOGLE_DRIVE_DOWNLOAD = 326;
    public static final int GOOGLE_DRIVE_LIST = 324;
    public static final int GOOGLE_DRIVE_TRASH = 325;
    public static final int GOOGLE_DRIVE_SIGN_IN = 327;
    public static final int KEYBOARD = 328;
    public static final int NAVIGATION_BAR = 329;
    public static final int NFC_TAG = 330;

    public static final int SAY_WAVENET = 334;
}